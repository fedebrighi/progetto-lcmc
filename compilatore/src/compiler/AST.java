...
public class AST {
	...
	public static class ClassCallNode extends Node {
		...
		ClassCallNode(String oId, String mId, List<Node> arg) {
			objectId = oId;
			methodId = mId;
			arglist = Collections.unmodifiableList(arg);
		}
	...
	public static class ClassTypeNode extends TypeNode {
		...
		ClassTypeNode(ArrayList<TypeNode> allF, ArrayList<ArrowTypeNode> allM) {
			allFields = allF;
			allMethods = allM;
		}
